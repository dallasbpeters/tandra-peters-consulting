...
const SCENE_CAPTION_WINDOWS = [
  { from: 6, scene: "storm", to: 150 },
  { from: 156, scene: "straightAnswers", to: 300 },
  { from: 306, scene: "inspection", to: 450 },
  { from: 456, scene: "managed", to: 630 },
  { from: 636, scene: "proof", to: 750 },
  { from: 756, scene: "closing", to: 898 },
] as const;
