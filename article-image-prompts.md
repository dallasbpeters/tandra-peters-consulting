# Tandra Peters — Article Image Prompts & Series Templates
...
## 5 Image Series Templates

These templates define the visual composition system. Every article image should use ONE of these templates, creating a cohesive but varied series across the blog.
...
- Thin accent lines or geometric shapes in sage green (`#69A758`) as subtle framing
- Shadow direction: soft, directly below (noon-style)

**Example composition:** Roof material samples, a clipboard, measuring tape, and a pencil arranged overhead on a cream surface — everything in the brand palette
...
- Accent details (a single tree, a weather vane, a chimney) in sage green (`#69A758`)
- Clouds or weather elements as subtle texture, not literal

**Example composition:** A simplified Texas neighborhood skyline silhouetted against a warm gradient sky, one roof highlighted with an accent color detail
...
- Texture in the foreground subject (grain of shingle, metal surface)
- Minimal background elements, mostly negative space

**Example composition:** Close-up of illustrated roof flashing around a chimney, with a small coral circle highlighting a gap, background fading to soft teal
...
- Simplified iconic objects on each side representing the two options
- Small labels or icons in the accent colors
- Shared cream background tying both halves together

**Example composition:** Left side shows a simplified shingle texture in teal tones, right side shows a standing seam metal panel in sage green tones, divided by a clean diagonal line on a cream background
...
- Accent elements (hard hat, clipboard, magnifying glass) in sage green or coral
- Warm cream background with subtle paper texture
- No faces — keep figures abstracted (silhouette or minimal features)

**Example composition:** An illustrated figure in teal holding a clipboard, gesturing toward a simplified house cross-section showing roof layers, all on a cream background with sage green accent details

---

## Article Image Prompts

Each prompt specifies the recommended template and a complete image generation prompt.

---

### 1. Texas Weather and Your Roof: Lifespan and Warning Signs
...
### 2. Maintaining Your Roof After Installation
...
### 3. How to Choose a Roofing Consultant in Austin (and Across Texas)
...
### 4. Storm Damage: When to Repair vs. When to Replace the Roof
...
### 5. Asphalt Shingle vs. Metal Roofing: Planning a Replacement in Texas
...
### 6. Homeowners Insurance and Roof Damage: A Practical Guide
...
### 7. What to Expect During a Professional Roof Inspection
...
### 8. The Texas Roof Replacement Process: What Homeowners Should Expect
...
- **Ratio:** 4:3 landscape for all images
- **Style:** Flat vector illustration, clean geometry, minimal detail
- **Color mode:** Use brand hex values exactly — these are the only colors in the palette
- **No text in images** — keep them purely visual
- **No photorealistic faces** — figures should be silhouettes or highly abstracted
- **Consistency:** All 8 images should feel like they belong to the same series despite using different templates
- **File format:** PNG with transparent or cream background, 1600×1200px minimum for retina blog display
